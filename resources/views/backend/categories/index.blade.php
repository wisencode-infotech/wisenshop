                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-auto">
                        <div class="text-sm-end">
                            <a href="{{ route('backend.category.create') }}" class="btn btn-success btn-rounded" id="addProject-btn"><i class="mdi mdi-plus me-1"></i> Add New</a>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
...
@endsection
@section('script')
<script src="{{ asset('assets/backend/js/datatable/categories.js') }}"></script>
@endsection