<button  wire:navigate href="{{ route('frontend.cart') }}"
    data-variant="custom"
    class="relative inline-flex items-center justify-center rounded-full border border-border-200 bg-light text-accent transition duration-300 ease-in-out hover:bg-accent-hover focus:outline-none hover:text-white focus:ring-2 focus:ring-accent-700 h-12 w-12">
