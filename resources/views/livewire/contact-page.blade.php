    ...
    <div
        ...
        <div class="order-2 w-full shrink-0 rounded-lg bg-light p-5 md:order-1 md:w-72 lg:w-96">
            ...
            <div class="mb-8 flex flex-col"><span class="mb-3 font-semibold text-heading">Address</span><span
                    class="text-sm text-body"><a class="" target="_blank" title="NY State Thruway, New York, USA"
                        href="https://www.google.com/maps/place/NY State Thruway, New York, USA">NY State Thruway, New
                        York, USA</a></span></div>
            <div class="mb-8 flex flex-col"><span class="mb-3 font-semibold text-heading">Phone</span><span
                    class="text-sm text-body">+129290122122</span></div>
            <div class="mb-8 flex flex-col"><span class="mb-3 font-semibold text-heading">Email Address</span><span
                    class="text-sm text-body">demo@demo.com</span></div>
            <div class="mb-8 flex flex-col"><span class="mb-3 font-semibold text-heading">Website</span>
                <div class="flex items-center justify-between"><span class="text-sm text-body">https://redq.io</span><a
                        class="text-sm font-semibold text-accent hover:text-accent-hover focus:text-blue-500 focus:outline-none"
                        target="_blank" href="https://redq.io">Visit This Site</a></div>
            </div>
            <div class="mb-8 flex flex-col"><span class="mb-4 font-semibold text-heading">Follow Us</span>
                <div class="flex items-center justify-start"><a
                        ...
                        target="_blank" title="https://www.facebook.com/redqinc"
                        href="https://www.facebook.com/redqinc"><svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 12 12" class="w-4 h-4">
                            <path data-name="_ionicons_svg_logo-facebook (6)"
                        ...
                        class="text-muted transition-colors duration-300 focus:outline-none ltr:mr-8 ltr:last:mr-0 rtl:ml-8 rtl:last:ml-0 hover:undefined"
                        target="_blank" title="https://twitter.com/RedqTeam" href="https://twitter.com/RedqTeam"><svg
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.747 12" class="w-4 h-4">
                            <path data-name="_ionicons_svg_logo-twitter (5)"
                        ...
                        class="text-muted transition-colors duration-300 focus:outline-none ltr:mr-8 ltr:last:mr-0 rtl:ml-8 rtl:last:ml-0 hover:undefined"
                        target="_blank" title="https://www.instagram.com/redqteam"
                        href="https://www.instagram.com/redqteam"><svg data-name="Group 96"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 12 12" class="w-4 h-4">
