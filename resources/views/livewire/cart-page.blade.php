                        ...
                        <div>
                           @foreach($cart as $cart_key => $item)
                              <div class="flex items-center border-b border-solid border-border-200 border-opacity-75 px-4 py-4 text-sm sm:px-6" style="opacity: 1;">
                                 ...
                                 @livewire('quantity-selector', ['product_id' => $item['product_id'], 'product_variation_id' => $item['product_variation_id'], 'layout' => 'cart', key('quantity-selector-' . $item['product_id'])])
