<div class="p-4 sm:p-8 bg-gray-50 min-h-screen flex items-center justify-center">
   <div class="w-full max-w-screen-md bg-white rounded-lg shadow-lg p-6">
      ...
      <div class="text-center mb-8">
         <h1 class="text-4xl font-bold text-red-600">Payment Error</h1>
         <p class="text-gray-600 mt-2">There was an issue with your payment. Please review the details below.</p>
      </div>
      ...
      <div class="p-6 rounded-lg border bg-gray-50 shadow-inner text-gray-700">
         <div class="mb-4">
            <span class="font-bold text-lg text-gray-800">Status:</span> {{ $status }}
         </div>
         <div class="mb-4">
            <span class="font-bold text-lg text-gray-800">Order ID:</span> {{ $orderId }}
         </div>
         <div>
            <span class="font-bold text-lg text-gray-800">Error Message:</span>
